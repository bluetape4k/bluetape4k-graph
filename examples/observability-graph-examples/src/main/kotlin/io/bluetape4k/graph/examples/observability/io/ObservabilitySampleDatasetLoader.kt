package io.bluetape4k.graph.examples.observability.io
...
/**
 * graph-io로 observability incident sample CSV dataset을 import한다.
 */
object ObservabilitySampleDatasetLoader {

    const val DEFAULT_VERTICES_RESOURCE: String = "sample-data/observability/vertices.csv"
    const val DEFAULT_EDGES_RESOURCE: String = "sample-data/observability/edges.csv"
    ...
    fun importCsv(
        ...
        withClasspathCsvGraphImportSource(
            ...
            fallbackClassLoader = ObservabilitySampleDatasetLoader::class.java.classLoader,
