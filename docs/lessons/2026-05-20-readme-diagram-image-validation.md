...
README diagrams in bluetape4k-graph were refreshed with the shared pastel infographic renderer. The work covers current Mermaid blocks and existing README diagram image links recovered from git history.
...
- Visual contact sheet review: `/tmp/bluetape4k-graph-diagram-review-samples.png`
- `git diff --check`
