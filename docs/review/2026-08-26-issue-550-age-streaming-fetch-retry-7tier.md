...
- 기준 ref: `fix/issue-550-age-streaming-fetch-retry`의 PR #573 live exact head (base는 #535 PR #572 exact head `03513d1a68bddda34105e2f48cb67bd0eb4ee0e6`; exact head는 self-referential SHA를 피하기 위해 GitHub PR metadata를 authoritative receipt로 사용)
