...
Read [graph operations](./graph-operations.md), [graph I/O](./graph-io.md), and [AGE and Neo4j](./age-and-neo4j.md). Consumers use `bluetape4k-graph-bom:0.5.1` and omit individual graph module versions; benchmark projects themselves are release fixtures, not published libraries.
