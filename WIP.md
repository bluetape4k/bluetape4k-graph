...
test-fixtures·README EN/KO·KDoc·7-Tier evidence의 hosted exact-head 검증을
대기 중이다.
...
| [#554](https://github.com/bluetape4k/bluetape4k-graph/issues/554) | PR #578 hosted 검증 대기 | #553 PR #577 exact head 위에서 `java-test-fixtures` 기반 reusable state-store TCK를 추가했다. 기본 invariant 4개, retry/save 경계 3개, atomic save failure 1개를 포함해 targeted 8/8·graph-io-core 151/151·Detekt·금지 assertion scan·diff-check를 통과했고 PR #578을 생성했다. implementation commits `98dddf35`, `ccc6c7ac`, retry guard `4375f03f`, docs receipt `68fa57d7`이며 hosted exact-head checks와 최종 lifecycle read-back을 대기 중이다. 실제 durable backend와 merge는 이 slice 범위 밖이며 전체 train 마지막 승인 단계까지 보류한다. |
