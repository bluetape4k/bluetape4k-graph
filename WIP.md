...
같은 경계를 통과한다. PR #584 exact head `6309412799416f94bb2367948da9a6a4b4b8744f`의
CI `32913808915`와 Examples `32913809041`가 모두 terminal green이며,
review·최종 merge를 대기한다. 전체 train merge는 마지막 일괄 승인 단계까지
보류한다.
...
| [#559](https://github.com/bluetape4k/bluetape4k-graph/issues/559) | PR #584 hosted 통과, review·merge 대기 | #558 PR #583 exact head `283dbd2fe9c8337699f510a8844d16094bbd06dc` 위에서 weighted Dijkstra/A*의 inclusive `maxDepth`, depth-aware predecessor, backend sync/suspend/virtual-thread conformance TCK와 EN/KO matrix를 추가했다. graph-core RED→GREEN, Neo4j 13개·Memgraph 10개·AGE 10개·FalkorDB 10개 weighted TCK 및 TinkerGraph fixture를 통과했고 PR #584 exact head `6309412799416f94bb2367948da9a6a4b4b8744f`의 CI `32913808915`·Examples `32913809041`가 모두 성공했다. 전체 train merge는 마지막 승인 단계까지 보류한다. |
