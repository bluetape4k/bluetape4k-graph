...
The spool normalizes property values using the writer string contract, closes
active replay streams during cleanup, and deletes its temporary files on normal
