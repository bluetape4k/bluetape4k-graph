...
import io.bluetape4k.graph.io.jackson2.internal.Jackson2ParsedRecord
 ...
 */
class Jackson2NdJsonRecordFlowReader(
    ...
    private val parser = Jackson2RecordParser()
    ...
    private fun toVertex(parsed: Jackson2ParsedRecord): GraphIoVertexRecord = try {
    ...
    private fun toEdge(parsed: Jackson2ParsedRecord): GraphIoEdgeRecord = try {
